...
Проект виконано як результат вивчення блоку **HTML+CSS** курсу **FullStack Developer** у [GoIT Academy](https://goit.global/ua/).
...
Над розділами працювали паралельно. Над задачами кожного розділу працювали послідовно.
